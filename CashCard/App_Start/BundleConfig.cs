    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/blueimp").Include(
                "~/Scripts/blueimp/blueimp-helper.js",
                "~/Scripts/blueimp/blueimp-gallery.js",
                "~/Scripts/blueimp/blueimp-gallery-fullscreen.js",
                "~/Scripts/blueimp/blueimp-gallery-indicator.js",
            ...
            bundles.Add(new StyleBundle("~/content/blueimp/blue").Include(
                "~/Content/blueimp/blueimp-gallery.css"));
